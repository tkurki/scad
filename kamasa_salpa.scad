...
difference() {
  ...
  translate([edge_ridge_width,-0.5,-1]) 
    cube([8.5,18,6], false);
  ...
  translate([
    ...
    center_ridge_width,-0.5,-1]) 
    cube([left_channel_top_width,18,6], false);

  //left channel bottom
  translate([edge_ridge_width+8.5+center_ridge_width,-0.5,2]) 
    cube([channel_bottom_width,35,3], false);
  
  //hollow
  translate([edge_ridge_width,center_ridge_length,-1]) 
    cube([
      right_channel_top_width +
      center_ridge_width +
      left_channel_top_width, 19, 6], false);
